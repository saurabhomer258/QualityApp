...
public class PWresetActivity extends Activity {
    ...
    private void initializeGUI(){
        ...
        ivLogo = (ImageView) findViewById(R.id.ivLogLogo);
        ivPWreset = (ImageView) findViewById(R.id.ivPassReset);
        tvInfo = (TextView) findViewById(R.id.tvPWinfo);
        tvSignin = (TextView) findViewById(R.id.tvGoBack);
        atvEmail = (AutoCompleteTextView) findViewById(R.id.atvEmailRes);
