...
public class DailyFinishingGetupResult extends AppCompatActivity {
    TextView data1,data2,data3;
    PieChart pieChart;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_daily_finishing_getup_result);
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(DailyFinishingGetupResult.this, CardMenuP.class);
                startActivity(i);
                finish();
            }
        });
