    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i =new Intent(DailyfinishingGetUpAdmin.this, DailyFinishingGetupResult.class);
                startActivity(i);
                finish();
            }
        });
        FirebaseDatabase.getInstance().getReference("dailyFinishinggetup")
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DailyFinishinfModels finishinfModels : dailyFinishinfModels)
                {
                    ...
                    {
                        Toast.makeText(DailyfinishingGetUpAdmin.this, "Sorry", Toast.LENGTH_SHORT).show();
                    }
